...
const agesOver18 = ages1.filter((age) => age > 18);
...
// 4.4 Streamers cuyo name incluye 'u'
const streamers2 = [
  { name: "Rubius", age: 32, gameMorePlayed: "Minecraft" },
  { name: "Ibai", age: 25, gameMorePlayed: "League of Legends" },
  { name: "Reven", age: 43, gameMorePlayed: "League of Legends" },
...
// 4.5 Streamers cuyo gameMorePlayed incluye 'Legends'
// y poner el gameMorePlayed en MAYÚSCULAS si age > 35
const streamers3 = [
  { name: "Rubius", age: 32, gameMorePlayed: "Minecraft" },
  { name: "Ibai", age: 25, gameMorePlayed: "League of Legends" },
  { name: "Reven", age: 43, gameMorePlayed: "League of Legends" },
...
const legendsStreamers = streamers3
  ...
  .map((streamer) => {
    if (streamer.age > 35) {
      // devolvemos una copia modificada para no tocar el original
      return {
        ...streamer,
